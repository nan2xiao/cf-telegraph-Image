...
$smfile.fileinput({
    ...
    allowedFileExtensions: ['jpeg', 'jpg', 'png', 'gif', 'bmp', 'mp4', 'mov', 'avi', 'webp'],
...
function render_uploaded() {
    ...
    uploaded_files.forEach(function (x) {
        ...
        const WPRAW = ""  //使用wordpress.com加速 https://i3.wp.com/telegra.ph
        const PhRAW = ""   //原地址 https://telegra.ph
        const PROXYURL = "https://cf-telegraph-image.pages.dev"  //自定义加速域名 默认是使用cloudflare
